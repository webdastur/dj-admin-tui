"""FilterSidebar — renders Django's own ``list_filter`` specs (v2 / FR-004).

The TUI never computes a filter predicate (Constitution I). This widget reads
        ...
        for title, choices in groups:
            ...
            for choice in choices:
                ...
                option_list.add_option(
                    Option(f"  {marker} {display}", id=opt_id)
                )
