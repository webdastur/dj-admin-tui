...
class FieldWidgetRegistry:
    ...
    The default singleton is `dj_admin_tui.field_widgets`. Custom registries
    are not part of the public API at v1.0.
    """
...
#: The default process-wide field-widget registry. Public API.
